...
/**
 * Functional test for the controllers defined inside the DemoUserController used
 ...
 *     $ ./vendor/bin/phpunit
 */
class DemoUserControllerTest extends WebTestCase
{
    /**
    ...
    public function testEditDemoUser(): void
    {
        ...
        $client->submitForm('Save', [
            'demo_user[email]' => $newUserEmail,
        ]);

        $this->assertResponseRedirects('/en/profile/edit', Response::HTTP_FOUND);

        /** @var \App\Entity\DemoUser $user */
        $user = self::$container->get(DemoUserRepository::class)->findOneByEmail($newUserEmail);
